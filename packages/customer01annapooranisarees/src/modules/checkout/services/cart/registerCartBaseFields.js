...
const normalizePort = require('@customer01annapooranisarees/customer01annapooranisarees/bin/lib/normalizePort');
    ...
    },
    {
      ...
      resolvers: [
        async function resolver(shippingMethod) {
          ...
          // By default, customer01annapooranisarees supports free shipping and flat rate shipping method
