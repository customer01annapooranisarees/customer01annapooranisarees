...
const {
  loadBootstrapScript
} = require('@customer01annapooranisarees/customer01annapooranisarees/bin/lib/bootstrap/bootstrap');
const { getCoreModules } = require('@customer01annapooranisarees/customer01annapooranisarees/bin/lib/loadModules');
const { getEnabledExtensions } = require('@customer01annapooranisarees/customer01annapooranisarees/bin/extension');
