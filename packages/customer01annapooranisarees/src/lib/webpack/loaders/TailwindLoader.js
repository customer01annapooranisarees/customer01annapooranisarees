...
module.exports = exports = function TailwindLoader(c) {
  ...
  mergedTailwindConfig.content = [
    ...
    // All file in packages/customer01annapooranisarees/src and name is capitalized
    join(CONSTANTS.ROOTPATH, 'packages', 'customer01annapooranisarees', 'src', '**', '[A-Z]*.jsx'),
    // All file in node_modules/@customer01annapooranisarees/customer01annapooranisarees/src and name is capitalized
    join(
      CONSTANTS.ROOTPATH,
      'node_modules',
