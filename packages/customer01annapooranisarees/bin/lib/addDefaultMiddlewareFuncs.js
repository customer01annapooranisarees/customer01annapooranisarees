...
const { debug } = require('@customer01annapooranisarees/customer01annapooranisarees/src/lib/log/logger');
const middleware = require('webpack-dev-middleware');
const {
  createConfigClient
} = require('@customer01annapooranisarees/customer01annapooranisarees/src/lib/webpack/dev/createConfigClient');
...
const publicStatic = require('@customer01annapooranisarees/customer01annapooranisarees/src/lib/middlewares/publicStatic');
const themePublicStatic = require('@customer01annapooranisarees/customer01annapooranisarees/src/lib/middlewares/themePublicStatic');
...
} = require('@customer01annapooranisarees/customer01annapooranisarees/src/modules/auth/services/getAdminSessionCookieName');
const {
  getFrontStoreSessionCookieName
} = require('@customer01annapooranisarees/customer01annapooranisarees/src/modules/auth/services/getFrontStoreSessionCookieName');
const {
  getCookieSecret
} = require('@customer01annapooranisarees/customer01annapooranisarees/src/modules/auth/services/getCookieSecret');
