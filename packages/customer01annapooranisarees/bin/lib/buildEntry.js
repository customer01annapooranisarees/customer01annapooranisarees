...
} = require('@customer01annapooranisarees/customer01annapooranisarees/src/lib/componee/getComponentsByRoute');
...
const {
  parseGraphql
} = require('@customer01annapooranisarees/customer01annapooranisarees/src/lib/webpack/util/parseGraphql');
...
} = require('@customer01annapooranisarees/customer01annapooranisarees/src/lib/webpack/util/keyGenerator');
/**
...
module.exports.buildEntry = async function buildEntry(
  ...
  await Promise.all(
    routes.map(async (route) => {
      ...
      import Area from '@customer01annapooranisarees/customer01annapooranisarees/src/components/common/Area';
      import Hydrate from '@customer01annapooranisarees/customer01annapooranisarees/src/components/common/react/client/${
      ...
      if (!clientOnly) {
        ...
        contentServer += '\r\n';
        contentServer += `import Area from '@customer01annapooranisarees/customer01annapooranisarees/src/components/common/Area';`;
        contentServer += '\r\n';
