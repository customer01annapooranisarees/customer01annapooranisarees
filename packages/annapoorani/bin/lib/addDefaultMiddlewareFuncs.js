...
const { debug } = require('@customer01annapooranisarees/annapoorani/src/lib/log/logger');
const middleware = require('webpack-dev-middleware');
const {
  createConfigClient
} = require('@customer01annapooranisarees/annapoorani/src/lib/webpack/dev/createConfigClient');
const isDevelopmentMode = require('@customer01annapooranisarees/annapoorani/src/lib/util/isDevelopmentMode');
const {
  isBuildRequired
} = require('@customer01annapooranisarees/annapoorani/src/lib/webpack/isBuildRequired');
const publicStatic = require('@customer01annapooranisarees/annapoorani/src/lib/middlewares/publicStatic');
const themePublicStatic = require('@customer01annapooranisarees/annapoorani/src/lib/middlewares/themePublicStatic');
...
const {
  translate
} = require('@customer01annapooranisarees/annapoorani/src/lib/locale/translate/translate');
const isProductionMode = require('@customer01annapooranisarees/annapoorani/src/lib/util/isProductionMode');
const { getConfig } = require('@customer01annapooranisarees/annapoorani/src/lib/util/getConfig');
const {
  getAdminSessionCookieName
} = require('@customer01annapooranisarees/annapoorani/src/modules/auth/services/getAdminSessionCookieName');
const {
  getFrontStoreSessionCookieName
} = require('@customer01annapooranisarees/annapoorani/src/modules/auth/services/getFrontStoreSessionCookieName');
const {
  getCookieSecret
} = require('@customer01annapooranisarees/annapoorani/src/modules/auth/services/getCookieSecret');
