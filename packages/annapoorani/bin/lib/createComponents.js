...
const { Componee } = require('@customer01annapooranisarees/annapoorani/src/lib/componee/Componee');
const isProductionMode = require('@customer01annapooranisarees/annapoorani/src/lib/util/isProductionMode');
const {
  getRouteBuildPath
} = require('@customer01annapooranisarees/annapoorani/src/lib/webpack/getRouteBuildPath');
...
module.exports.createComponents = async function createComponents(
  ...
  await Promise.all(
    routes.map(async (route) => {
      ...
      import Area from '@customer01annapooranisarees/annapoorani/src/lib/components/Area';
      `;
      if (isProductionMode()) {
        contentClient += `import Hydrate from '@customer01annapooranisarees/annapoorani/src/lib/components/react/client/Hydrate';`;
      } else {
        contentClient += `import { App } from '@customer01annapooranisarees/annapoorani/src/lib/components/react/client/Client';
      const hot = require('webpack-hot-middleware/client?path=/eHot/${route.id}&reload=true');
      import { HotReload } from '@customer01annapooranisarees/annapoorani/src/lib/components/react/client/HotReload';
      `;
      }
      contentClient += '\r\n';
      ...
      if (!clientOnly) {
        ...
        contentServer += '\r\n';
        contentServer += `import Area from '@customer01annapooranisarees/annapoorani/src/lib/components/Area';`;
        contentServer += '\r\n';
