...
} = require('@customer01annapooranisarees/annapoorani/src/lib/componee/getComponentsByRoute');
...
const {
  parseGraphql
} = require('@customer01annapooranisarees/annapoorani/src/lib/webpack/util/parseGraphql');
const JSON5 = require('json5');
const { error } = require('@customer01annapooranisarees/annapoorani/src/lib/log/logger');
const {
  getEnabledWidgets
} = require('@customer01annapooranisarees/annapoorani/src/lib/util/getEnabledWidgets');
const {
  generateComponentKey
} = require('@customer01annapooranisarees/annapoorani/src/lib/webpack/util/keyGenerator');
/**
...
module.exports.buildEntry = async function buildEntry(
  ...
  await Promise.all(
    routes.map(async (route) => {
      ...
      import Area from '@customer01annapooranisarees/annapoorani/src/components/common/Area';
      import Hydrate from '@customer01annapooranisarees/annapoorani/src/components/common/react/client/${
      ...
      if (!clientOnly) {
        ...
        contentServer += '\r\n';
        contentServer += `import Area from '@customer01annapooranisarees/annapoorani/src/components/common/Area';`;
        contentServer += '\r\n';
