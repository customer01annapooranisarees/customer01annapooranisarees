...
const {
  loadModuleRoutes
} = require('@customer01annapooranisarees/annapoorani/src/lib/router/loadModuleRoutes');
...
const { buildEntry } = require('@customer01annapooranisarees/annapoorani/bin/lib/buildEntry');
const { getCoreModules } = require('@customer01annapooranisarees/annapoorani/bin/lib/loadModules');
const { error } = require('@customer01annapooranisarees/annapoorani/src/lib/log/logger');
const { lockHooks } = require('@customer01annapooranisarees/annapoorani/src/lib/util/hookable');
const { lockRegistry } = require('@customer01annapooranisarees/annapoorani/src/lib/util/registry');
const {
  validateConfiguration
} = require('@customer01annapooranisarees/annapoorani/src/lib/util/validateConfiguration');
