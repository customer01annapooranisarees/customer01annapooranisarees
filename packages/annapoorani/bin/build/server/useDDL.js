...
const { getRoutes } = require('@customer01annapooranisarees/annapoorani/src/lib/router/routes');
const {
  getComponentsByRoute
} = require('@customer01annapooranisarees/annapoorani/src/lib/componee/getComponentByRoute');
const webpack = require('webpack');
const { info } = require('@customer01annapooranisarees/annapoorani/src/lib/log/logger');
...
const {
  createVendorConfig
} = require('@customer01annapooranisarees/annapoorani/src/lib/webpack/configProvider');
