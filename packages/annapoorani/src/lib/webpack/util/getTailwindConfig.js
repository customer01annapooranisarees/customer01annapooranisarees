...
module.exports.getTailwindConfig = function getTailwindConfig(route) {
  const defaultTailwindConfig = route.isAdmin
    ? require('@customer01annapooranisarees/annapoorani/src/modules/cms/services/tailwind.admin.config.js')
    : require('@customer01annapooranisarees/annapoorani/src/modules/cms/services/tailwind.frontStore.config.js');
