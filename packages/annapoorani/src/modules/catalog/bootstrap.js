...
module.exports = () => {
  ...
  const widgets = {
    collection_products: {
      setting_component:
        '@customer01annapooranisarees/annapoorani/src/components/admin/widgets/CollectionProductsSetting.jsx',
      component:
        '@customer01annapooranisarees/annapoorani/src/components/frontStore/widgets/CollectionProducts.jsx',
