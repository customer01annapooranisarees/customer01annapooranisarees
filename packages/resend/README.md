...
> **Note**: You can check the example email templates [here](https://github.com/customer01annapooranisareescommerce/customer01annapooranisarees/tree/main/packages/resend/email_template_examples).